...
class AddToCart(BasePage):
    ...
    def add_to_cart_inventory(self):
        add_to_inventory1: WebElement =self.wait.until(self.EC.element_to_be_clickable(self._ADD_INVENTORY1))
        add_to_inventory1.click()
        add_to_inventory2: WebElement = self.wait.until(self.EC.element_to_be_clickable(self._ADD_INVENTORY2))
